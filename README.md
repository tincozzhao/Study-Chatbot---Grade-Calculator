# Y2K Baby-Blue Grade Calculator

Open `index.html` in a browser to use the calculator locally.
...
Notes:
- The prediction uses a simple, transparent weighted heuristic for quick estimates — not a trained ML model.
